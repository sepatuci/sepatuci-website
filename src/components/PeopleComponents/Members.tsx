...
const teamMembers = [
  // Alpha Class (Alphabetical Order)
  {
    description: "Alpha Class",
    title: "Ayaan Dhir",
    src: ayaan.src,
    ctaLink: "https://www.linkedin.com/in/ayaandhir/",
    category: "Active",  // Added category
  },
  // Beta Class (Alphabetical Order)
  {
  ...
  // Delta Class (Alphabetical Order)
  {
  ...
  // Epsilon Class (Alphabetical Order)
  {
