    ...
    <section className="text-white body-font bg-black">
      <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-center md:text-left mb-16 md:mb-0 items-center text-center">
          ...
          Founder's Education is focused on developing our newest members personally and professionally, 
          by fostering a tight-knit community. Designed for all experience levels, FE is 
